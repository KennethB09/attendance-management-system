 ...
 * Modern and professional design with background image
 * ---------------------------------------------------*/
...
<a href="?tab=announcements" class="view-all-btn">View All Announcements</a>
            ...
            <div class="tab-content <?php echo $active_tab == 'classes' ? 'active' : ''; ?>" id="classes-tab">
                ...
                <div class="card" id="create-class-card">
                    <h3><div class="card-icon"><i class="fas fa-plus"></i></div> Create New Class</h3>
            ...
            <div class="tab-content <?php echo $active_tab == 'students' ? 'active' : ''; ?>" id="students-tab">
                ...
                <div class="card">
                    <h3><div class="card-icon"><i class="fas fa-user-plus"></i></div> Add New Student</h3>
                    <div class="card-content">
            ...
            <div class="tab-content <?php echo $active_tab == 'attendance' ? 'active' : ''; ?>" id="attendance-tab">
                ...
                <div class="card">
                    <h3><div class="card-icon"><i class="fas fa-clipboard-check"></i></div> Mark Attendance</h3>
                    <div class="card-content">
                ...
                <div class="card">
                    <h3><div class="card-icon"><i class="fas fa-qrcode"></i></div> QR Attendance</h3>
                    <div class="card-content">
                        <div class="form-grid">
                            <div class="form-group">
            ...
            <div class="tab-content <?php echo $active_tab == 'announcements' ? 'active' : ''; ?>" id="announcements-tab">
                ...
                <div class="card">
                    <h3><div class="card-icon"><i class="fas fa-bullhorn"></i></div> Create Announcement</h3>
                    <div class="card-content">
            ...
            <div class="tab-content <?php echo $active_tab == 'settings' ? 'active' : ''; ?>" id="settings-tab">
                ...
                <div class="card">
                    <h3><div class="card-icon"><i class="fas fa-user-edit"></i></div> Update Profile</h3>
                    <div class="card-content">
                ...
                <div class="card">
                    <h3><div class="card-icon"><i class="fas fa-lock"></i></div> Change Password</h3>
                    <div class="card-content">
                ...
                <div class="card">
                    <h3><div class="card-icon"><i class="fas fa-image"></i></div> Update Profile Picture</h3>
                    <div class="card-content">
                ...
                <div class="card">
                    <h3><div class="card-icon"><i class="fas fa-cogs"></i></div> System Settings</h3>
                    <div class="card-content">
